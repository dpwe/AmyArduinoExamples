...
timed_note bass_notes[] = {
  { 0.0, 0.3, 43, 0.2},   // bass G2
  { 1.0, 0.3, 38, 0.2},   // bass D2
  { 2.0, 0.3, 41, 0.2},   // bass F2
  { 3.0, 0.3, 43, 0.2},   // bass G2
  { 4.0, 0.3, 41, 0.2},   // bass F2
  { 5.0, 0.3, 38, 0.2},   // bass D2
  { 6.0, 0.3, 36, 0.2},   // bass C2
  { 7.0, 0.3, 38, 0.2},   // bass D2
};

timed_note chord_notes[] = {
  { 0.0, 0.1, 70, 1.0},  // Fmin:1
  { 0.0, 0.1, 74, 1.0},
  { 0.0, 0.1, 79, 1.0},
  { 3.0, 0.1, 72, 1.0},  // Amin:1
  { 3.0, 0.1, 76, 1.0},
  { 3.0, 0.1, 81, 1.0},
  { 8.0, 0.1, 74, 1.0},  // Bb:1
  { 8.0, 0.1, 77, 1.0},
  { 8.0, 0.1, 82, 1.0},
  { 11.0, 0.1, 72, 1.0},  // Amin:1
  { 11.0, 0.1, 76, 1.0},
  { 11.0, 0.1, 81, 1.0},
};
...
void schedule_notes(int time, int channel, struct timed_note *notes, int num_notes) {
  ...
  for (int i = 0; i < num_notes; ++i) {
    ...
    if (notes[i].duration > 0) {
      e.time += millis_per_tick * 2 * notes[i].duration;
      e.velocity = 0;
      amy_add_event(&e);
    }
  }
